...
def main():
    ...
    #columns2 = ['team', 'skill', 'skill_type', 'skill_subtype', "start_coordinate_x",	"start_coordinate_y",	"mid_coordinate_x",	"mid_coordinate_y",	"end_coordinate_x",	"end_coordinate_y"]
    #data_path = 'export_our_test_value_FINAL_FINAL2_FINAL.csv'
    columns = []
    # for val in columns2:
    #     columns.append(val)
    #     columns.append(val + '1')
    #     columns.append(val + '2')
    #     columns.append(val + '3')
    #     columns.append(val + '4')
    # for val in columns2:
    #     columns.append(val)
    # for val in columns2:
    #     columns.append(val + '1')
    ...
    # columns.append('point_won_by')
    # columns.append('home_team_score')
    # columns.append('visiting_team_score')
    # columns.append('home_setter_position')
    # columns.append('visiting_setter_position')
    # columns.append('serving_team')
    # columns.append('home_touch')
    # columns.append('away_touch')
